...
/*var oxyz = new THREE.AxesHelper( 5);
	scene.add( oxyz );
var negativeOxyz= new THREE.AxesHelper( 5);
	negativeOxyz.setColors("black","black","black");
	negativeOxyz.rotateY(Math.PI);
	scene.add(negativeOxyz);*/
